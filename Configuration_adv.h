 ...
 */
/////////////////////////////////////////////////#define Z_STEPPER_AUTO_ALIGN //edit and uncomment requires dual z and bltouch
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  30, 115 }, { 205, 115 } } 
...
//
//////////////////////////////////////////#define ASSISTED_TRAMMING // edit and uncomment for bltouch
 ...
 */
//#define LIN_ADVANCE // cannot be used with 2208
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K         // (mm) Compression length applying to all extruders
  #endif
